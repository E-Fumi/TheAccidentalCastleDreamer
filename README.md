...
If you are unfamiliar with autoencoders you can refer to the 'Background' section just below. Some more examples of generated images showcasing what the model is able to learn at this stage can also be found there. If you want to run this code to train a model from scratch and play around with hyperparameters, you can do so following the instructions in the 'Usage' section.<br/>
...
<br/>
<p align="center">
  <img src="./readme_media/Collage.png" width="548" height="548"><br/>
